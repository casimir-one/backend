...
class ProjectContentProposalAcceptedEvent extends BaseEvent {
  ...
  constructor(eventPayload) {
    ...
    const { entityId, projectId, teamId, content, type, authors, title } = createProjectContentCmd.getCmdPayload();
    ...
    super(APP_EVENT.PROJECT_CONTENT_PROPOSAL_ACCEPTED, {
      proposalId,
      expirationTime,
      projectId,
      entityId,
...
module.exports = ProjectContentProposalAcceptedEvent;