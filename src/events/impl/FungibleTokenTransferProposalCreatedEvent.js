...
class FungibleTokenTransferProposalCreatedEvent extends BaseEvent {
  constructor(eventPayload) {
    ...
    super(APP_EVENT.FT_TRANSFER_PROPOSAL_CREATED, {
      proposalId, 
      expirationTime,
      party1,
      party2,
...
module.exports = FungibleTokenTransferProposalCreatedEvent;