...
class ProjectTokenSaleProposalCreatedEvent extends BaseEvent {
  constructor(eventPayload) {
    ...
    super(APP_EVENT.PROJECT_TOKEN_SALE_PROPOSAL_CREATED, { 
      proposalId, 
      expirationTime,
      teamId,
      projectId,
...
module.exports = ProjectTokenSaleProposalCreatedEvent;