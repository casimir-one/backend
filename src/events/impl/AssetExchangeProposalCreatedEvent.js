...
class AssetExchangeProposalCreatedEvent extends BaseEvent {
  constructor(eventPayload) {
    ...
    super(APP_EVENT.ASSET_EXCHANGE_PROPOSAL_CREATED, {
      proposalId, 
      expirationTime,
      party1,
      party2,
...
module.exports = AssetExchangeProposalCreatedEvent;