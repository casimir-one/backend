...
class NonFungibleTokenTransferProposalCreatedEvent extends BaseEvent {
  constructor(eventPayload) {
    ...
    super(APP_EVENT.NFT_TRANSFER_PROPOSAL_CREATED, {
      proposalId, 
      expirationTime,
      party1,
      party2,
...
module.exports = NonFungibleTokenTransferProposalCreatedEvent;