...
import { APP_PROPOSAL, APP_CMD, APP_EVENT } from '@casimir.one/platform-core';
import assert from 'assert';


class TokenSwapProposalAcceptedEvent extends BaseEvent {
  constructor(eventPayload) {
    ...
    super(APP_EVENT.TOKENS_SWAP_PROPOSAL_ACCEPTED, {
      proposalId, 
      expirationTime,
      party1,
      party2,
...
module.exports = TokenSwapProposalAcceptedEvent;