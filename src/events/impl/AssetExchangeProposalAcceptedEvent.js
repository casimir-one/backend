...
class AssetExchangeProposalAcceptedEvent extends BaseEvent {
  constructor(eventPayload) {
    ...
    super(APP_EVENT.ASSET_EXCHANGE_PROPOSAL_ACCEPTED, {
      proposalId, 
      expirationTime,
      party1,
      party2,
...
module.exports = AssetExchangeProposalAcceptedEvent;