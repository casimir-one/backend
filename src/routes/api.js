...
protected_route.get('/v2/assets/owner/:owner/symbol/:symbol', assetsCtrl.getFungibleTokenBalance)
protected_route.get('/v2/assets/owner/:owner', assetsCtrl.getFungibleTokenBalancesByOwner)
public_route.get('/v2/assets/accounts/symbol/:symbol', assetsCtrl.getFungibleTokenBalancesBySymbol)
...
protected_route.post('/v2/asset/ft/create', assetsCtrl.createFungibleToken)
protected_route.post('/v2/asset/nft/create', assetsCtrl.createNonFungibleToken)
protected_route.post('/v2/asset/ft/issue', assetsCtrl.issueFungibleToken)
protected_route.post('/v2/asset/nft/issue', assetsCtrl.issueNonFungibleToken)
