...
public_route.get('/v2/teams/listingPaginated', teamsCtrl.getTeamsListingPaginated)
...
public_route.get('/v2/project-content/listingPaginated', projectContentsCtrl.getPublicProjectContentListingPaginated)
