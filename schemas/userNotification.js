...
const UserNotification = new Schema({
    ...
    "type": {
        ...
        enum : [
            ...
            USER_NOTIFICATION_TYPE.RESEARCH_APPLICATION_CREATED,
            USER_NOTIFICATION_TYPE.RESEARCH_APPLICATION_APPROVED,
            USER_NOTIFICATION_TYPE.RESEARCH_APPLICATION_REJECTED,
            USER_NOTIFICATION_TYPE.RESEARCH_APPLICATION_EDITED,
            USER_NOTIFICATION_TYPE.RESEARCH_APPLICATION_DELETED
        ],
        required: true
    },
